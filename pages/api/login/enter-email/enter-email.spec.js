...
describe.concurrent('EnterEmailController', () => {
  ...
  it.runIf(ENV.isDevMode)('should be status 200 and "error: null and code: ... ..." if request is success', async () => {
    await testApiHandler({
      handler: EnterEmailController,
      test: async ({ fetch }) => {
        /** @type {RequestInit} */
  ...
  it.runIf(!ENV.isDevMode)('only prod -> should be status 200 and "error: null and code: null" if request is success', async () => {
    await testApiHandler({
      handler: EnterEmailController,
      test: async ({ fetch }) => {
        /** @type {RequestInit} */
  ...
  it.runIf(ENV.isDevMode)('should be status 200 and "error: null" if request is success', async () => {
    await testApiHandler({
      handler: EnterEmailController,
      test: async ({ fetch }) => {
        /** @type {RequestInit} */
